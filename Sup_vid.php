...
$page->head("Supportive Videos | Kardan E-Study");
$page->Session();
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12 pt-5 pl-3 textwhite" style="padding-left: 20%;">
                    <h3 class="textwhite animated slideInLeft">Supportive Videos </h3>
            ...
            <div class="row mt-3">
                <div class="col-lg-6 p-3 animated rotateInDownLeft " style="color:white;background-color: #1b1e21">
                    <h5>What is Marketing?</h5>
                        <video controls width="100%" height="300px" class="mb-3">
                            <source src="files/vid1.mp4" type="video/mp4">
                        </video>
                    <p>Get knowledge about digital Marketing...</p>
                    <a class="twhite btn btn-info text-center" methods="_blank" href="files/vid1.mp4">Download</a>
                    </div>
                <div class="col-lg-6 p-3 animated rotateInDownRight " style="color:white;background-color: #393b3e">
                    <h5>Different Marketing Methods</h5>
                        <video controls width="100%" height="300px" class="mb-3">
                            <source src="files/vid2.mp4" type="video/mp4">
                        </video>
                    <p>This video will briefly describe different methods of Digital Marketing...</p>
                    <a class="twhite btn btn-info text-center" href="files/vid2.mp4">Download</a>
                    </div>
