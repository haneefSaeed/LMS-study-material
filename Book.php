        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12 pt-5 pl-3 textwhite" style="padding-left: 20%;">
                    <h3 class="textwhite animated slideInLeft">Book </h3>
            ...
            <div class="row">
                <div class="col-lg-12 pt-2 ">
                    <iframe src="files/<?php $page->getSubjectNamebyID($sub_id); echo "/chapter ". $ch_id; ?>/Book.pdf" width="100%" height="565px" frameborder="0"></iframe>
                </div>
                </div>
